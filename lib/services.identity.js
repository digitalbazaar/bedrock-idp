...
function addRoutes(app) {
  ...
  app.get(idPath + '/settings',
      ensureAuthenticated,
      rest.makeResourceHandler());

  app.post(bedrock.config.identity.basePath,
    ensureAuthenticated,
    ...
    function(req, res, next) {
      ...
      identity.id = brIdentity.createIdentityId(req.body.sysSlug);
  ...
  docs.annotate.post(bedrock.config.identity.basePath, {
  ...
  app.get(bedrock.config.identity.basePath,
    ensureAuthenticated,
  ...
  docs.annotate.get(bedrock.config.identity.basePath, {
  ...
  app.get(idPath, cors(), function(req, res, next) {
    ...
    async.waterfall([
      function(callback) {
        ...
        brIdentity.getIdentity(null, identityId, function(
          err, identity, meta) {
          if(err) {
            return callback(err);
          }
      ...
      function(callback) {
        // get identity's keys
        brIdentity.getIdentityPublicKeys(
  ...
  app.post(idPath + '/email/verify',
    ...
    function(req, res, next) {
      ...
      brIdentity.verifyIdentityEmail(
    ...
    get: function(req, res, callback) {
      ...
      validate('identityCredentialsQuery', query, function(err) {
        ...
        if(req.query.authorize === 'true') {
          ...
          return brIdentity.signJsonLdAsIdentityService(identity, {
